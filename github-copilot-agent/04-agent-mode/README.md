...
พวกเราได้ใช้ Agent Mode ให้ Copilot เพิ่มฟีเจอร์ใหม่แบบ Autonomous ได้สำเร็จ ขั้นถัดไปเราจะเริ่มปรับแต่งวิธีทำงานของ Copilot เอง โดยเริ่มจาก `Custom Prompt` สำหรับงานที่ต้องทำซ้ำบ่อย
