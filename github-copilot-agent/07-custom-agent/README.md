...
คุณได้สร้าง `Custom Agent` ที่มีบทบาทเฉพาะสำหรับ review งานก่อนเปิด PR แล้ว จุดแข็งของวิธีนี้คือเราสามารถทำให้ Copilot รับผิดชอบงานเฉพาะทางได้อย่างสม่ำเสมอ และลดโอกาสที่มันจะออกนอกขอบเขต ในแบบฝึกหัดถัดไป เราจะใช้ Copilot ช่วย Commit, Push และสร้าง Pull Request จริง
