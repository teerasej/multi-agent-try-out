...
1. ใน root ของ note app สร้างโฟลเดอร์ `.github/skills/small-note-feature`
2. สร้างไฟล์ `.github/skills/small-note-feature/SKILL.md`
...
4. กด Save แล้วสังเกตว่า skill นี้ไม่ได้มีไว้แค่ “สั่งงาน 1 ครั้ง” แต่เป็นการสอน workflow ให้ Copilot ใช้ซ้ำกับงานแนวเดิมใน repo นี้
...
คุณได้สร้าง `Skill` ที่บอก Copilot ว่าควรทำงานแบบไหนกับ note app เมื่อเจองานประเภทเดิมซ้ำอีก จุดแข็งของ skill คือเหมาะกับ workflow ที่มีหลายขั้นตอนและมีความรู้เฉพาะ repo ในแบบฝึกหัดถัดไป เราจะสร้าง `Custom Agent` เพื่อให้ Copilot รับบทบาทเฉพาะทางชัดเจนขึ้น
